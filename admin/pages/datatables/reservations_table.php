...
<table id="reservations-table" class="table table-striped table-responsive" style="width:100%">
    <thead>
        <tr>
            <th>ID</th>
            <th>Event Date</th>
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                $reservationDate = $row["event_datetime"];
                $dateOfReservation = $row["rdates"];
                $isDone = ($row["is_done"] == 0) 
                    ? "<span class='text-danger fw-bold'>NOT YET</span>" 
                    : "<span class='text-success fw-bold'>YES</span>";
                $dateCreated = $row["date_created"];

                $default = "?page=reservations&process=";
                $editLink = $default. "edit&id=" .$id;
                ...
                <tr>
                    ...
                    <td><?php echo $dateOfReservation; ?></td>                   
                    ...
                    <td class="text-center">
                        ...
                        <!-- <a href="<?php echo $deleteLink ?>" class="btn btn-secondary" title="Delete">
